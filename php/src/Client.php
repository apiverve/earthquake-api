...
/**
 * Client for the Worldwide Earthquakes API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/earthquake?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/earthquake';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\EarthquakeClient] {$message}\n";
        }
    }
}
