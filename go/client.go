...
const (
	baseURL        = "https://api.apiverve.com/v1/earthquake"
	defaultTimeout = 30 * time.Second
)

// Client is the Worldwide Earthquakes API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Worldwide Earthquakes API client.
...
// Execute makes a request to the Worldwide Earthquakes API.
