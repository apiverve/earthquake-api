...
namespace APIVerve.API.WorldwideEarthquakes
{
    ...
    /// <summary>
    /// Client for the WorldwideEarthquakes API
    /// </summary>
    public class WorldwideEarthquakesAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/earthquake";
        ...
        public WorldwideEarthquakesAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WorldwideEarthquakesAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WorldwideEarthquakesAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, WorldwideEarthquakesQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(WorldwideEarthquakesQueryOptions options)
        {
        ...
        public ResponseObj Execute(WorldwideEarthquakesQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(WorldwideEarthquakesQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(WorldwideEarthquakesQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(WorldwideEarthquakesQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(WorldwideEarthquakesQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(WorldwideEarthquakesQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(WorldwideEarthquakesQueryOptions options)
        {
