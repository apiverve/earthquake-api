# Worldwide Earthquakes API - Examples

This folder contains example code for using the Worldwide Earthquakes API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/earthquake',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
- **API Reference:** [https://docs.apiverve.com/ref/earthquake](https://docs.apiverve.com/ref/earthquake)
