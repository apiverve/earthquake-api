# Worldwide Earthquakes Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:earthquake-api:1.1.13'
}
```
...
```java
import com.apiverve.earthquake.WorldwideEarthquakesAPIClient;
import com.apiverve.earthquake.APIResponse;
import com.apiverve.earthquake.APIException;

// Initialize the client
WorldwideEarthquakesAPIClient client = new WorldwideEarthquakesAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/earthquake](https://docs.apiverve.com/ref/earthquake)
...
- **Documentation:** [https://docs.apiverve.com/ref/earthquake](https://docs.apiverve.com/ref/earthquake)
- **Issues:** [GitHub Issues](https://github.com/apiverve/earthquake-api/issues)
